...
describe("independent fake ESP actor commands", () => {
  it("announces exact firmware identity fields on connect and discovery", () => {
    ...
    expect(actorPayloads(harness, harness.topics.announce)).toEqual([
      '{"protocolVersion":1,"name":"Alpha","freq":5000,"res":8,"id":"A1B2C3D4","status":"online","version":"6.0.3","hardwareProfile":"nodemcu-esp32s-v1.1","hardwareModel":"Ai-Thinker NodeMCU-32S V1.1","diagnosticStorageHealthy":true,"scheduleHash":"0"}',
    ]);
